...
Faisons ces étapes une à une, en commençant par le calcul de la matrice $LU$. Pour ce faire, on part de deux matrice : la matrice $A$ (qui va devenir la matrice $U$ à la fin du calcul) et la matrice $L$. 
